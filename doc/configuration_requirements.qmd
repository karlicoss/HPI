...
It's easy to achieve on it's own, but harder to achieve simultaneously with @configuration-should-be-backwards-compatible .
...
- [easy to write](#req-easy-to-write): **yes**, whatever is in the config can immediately be used by the code
- [ease of use](#req-easy-to-use): **mostly**, optional fields require extra code though
