...
After editing code read by the docs, such as `quarto_helpers.py` or module sources used by `modules.qmd`, run `tox -e quarto -- --execute` or delete `_freeze/` to re-execute the dependent docs.
